...
public class PostServiceTest {
    ...
    void 포스트작성이_성공한경우(){
        ...
        when(postEntityRepository.save(any())).thenReturn(mock(PostEntiity.class));
    ...
    void 포스트수정이_성공한경우(){
        ...
        PostEntiity postEntiity = PostEntityFixture.get(userName, postId,1);
        UserEntity userEntity =  postEntiity.getUser();
        //mocking

        when(userEntityRepository.findByUserName(userName)).thenReturn(Optional.of(userEntity));
        when(postEntityRepository.findById(postId)).thenReturn(Optional.of(postEntiity));
        when(postEntityRepository.saveAndFlush(any())).thenReturn(postEntiity);
